...
void setup() {
 ...
 orcFont = loadFont("Calibri-48.vlw");
}
void draw() {
...
void serialEvent (Serial myPort) { // starts reading data from the Serial Port
  ...
  try {
    ...
    // Hata durumu: istenilen karakter bulunamadı
      println("Hata: ',' karakteri bulunamadı");
    }
...
/*  try {
    ...
    // Hata durumunu işleyin veya kullanıcıya bir geri bildirim sağlayın
    e.printStackTrace(); // Hata izleme (Debug için)
}*/
}
void drawRadar() {
  pushMatrix();
